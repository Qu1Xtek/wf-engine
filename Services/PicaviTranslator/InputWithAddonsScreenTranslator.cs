...
{
    public class InputWithAddonsScreenTranslator : IPicaviScreenTranslator
    {
        public PicaviResponse BuildExecuteResponse(ActivityStateResult activityStateResult)
        {
            InputWithAddonsScreenActivity inputWithAddonsScreenActivity = JsonConvert.DeserializeObject<InputWithAddonsScreenActivity>(activityStateResult.ActivityMetadata);
            ...
            PicaviResponse response = new PicaviResponse()
            {
                ...
                PageData = BuildExecuteData(inputWithAddonsScreenActivity)
            };
        ...
        private PageData BuildExecuteData(InputWithAddonsScreenActivity inputScreenActivity)
        {
